...
{
	CDialogEx::DoDataExchange(pDX);
	DDX_Control(pDX, IDC_EDIT1, m_editor1);
	DDX_Control(pDX, IDC_EDIT2, m_editor2);
}
...
BOOL CMy03EditCtrlDlg::OnInitDialog()
{
	...
	/// 初始化编辑框
	m_editor1.SetWindowTextW(TEXT("C++学院"));
...
{
	CString str;
	m_editor1.GetWindowTextW(str);
	m_editor2.SetWindowTextW(str);
	// TODO: 在此添加控件通知处理程序代码
}
